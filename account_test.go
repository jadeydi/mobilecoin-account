...
func TestAccount(t *testing.T) {
	assert := assert.New(t)
	account, err := DecodeB58Code("d9V5WDNZxa7fNRw24JwaqDpCrRnKjpsGcN2CpLJNJZQjt7Vhwsmm2w2CoY4g2u7vy5HFxL5S8uGUUogApWteXdgrd3GnowaFUWU1HefMdGK7fdhWEcznR9SacnddL2KA3NmEzgDRoqqwHzTv8cPXo5udtRAy4Q4xYsPTmXkcZTH212SNXudQwA6KfwUqS3aKvJFMLcr1iUmfupMikwVYcfboJ6i3gejGhua5BVX1GRhL2BRWMHhnRCThqicQAy")
	assert.Nil(err)
	...
	account, err = DecodeB58Code(addr)
	address, err = account.B58Code()
	assert.Nil(err)
	log.Println(address)
	...
	account, err = DecodeB58Code("3DsoPZDzxAtCCvwuNKvmSQcqHaa6w99U2dxjroC8DXZTvMM2LJdUHDXXDVQEf3vqew5Xzc3nw5jKEUMUuqvNREfV5GVCyiEvusZUFJeeRt3ykVEfAnp6suXZe15R9vvNKMBf2sTR2Bk6PiRrwyNNFFchY1kYkdCsH4dAsGJmFpRB4kGkhXANxFbK7r2K1FTPGpPxav31XXkCaXB3KcTVEEWptGNnEYrDKJdvJvwuMdkzv8")
	assert.Nil(err)
	log.Printf("1:::%#v", account)

	account, err = DecodeB58Code("CpJVvph9KVdpngREbnazkU1Z5XvmYNeDzQxhf9ft1agRZYCBk9gdfY489ibBAHPEtbFTmcrK4tdXa47bbsgffq21FRErBWAHje83S67XvcybFA5CVkwZghjm8GCWEZGyFqdaZiHB4B54A1GBnmeHGJra97oz7vQUGPyQNYZnrS3CY2Et6SRoAweDwemuukGKmTcBG1kaJKWRjRVVktzuBYbXPvSzx9edbk9UirbKRoZHyu")
	assert.Nil(err)
